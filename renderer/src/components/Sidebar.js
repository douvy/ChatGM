...
export default function Sidebar({
  ...
  return (
    ...
    >
      ...
      />
      <i
        className={`fa-solid fa-arrow-left hidden-sm cursor-pointer text-gray w-5 h-5 mr-auto mb-3 ml-3 absolute bottom-0 left-0 transform transition duration-300 hover:scale-125 hover:font-bold`}
