    ...
    return (
        <div className="mx-auto max-w-[760px] mt-3 md:mt-6" id="my-account">
            ...
            <div class="flex w-full flex-row gap-x-6">
              <div class="relative h-[80px] w-[80px] cursor-pointer gap-10 border border-white/20 hover:border-white/40 lg:h-[104px] lg:w-[104px]">
                <Image
                  src="/avatar.png"
                  alt="profile picture"
                  layout="fill"
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="mt-auto">
                  <div className="flex flex-row gap-4">
                    <button className="relative whitespace-nowrap px-6 py-2 text-xs font-semibold uppercase tracking-wide transition-colors duration-200 border border-yellow text-yellow btn-yellow bg-transparent hover:text-black">Change</button>
            ...
            <div class="flex w-full flex-row gap-x-6 mt-10">
                <form className="flex w-full max-w-measure flex-col">
                  <div className="flex flex-col gap-2">
                    <div className="gap-2 text-xs font-semibold uppercase tracking-wide flex w-full flex-col items-stretch justify-center">
                      <label className="flex cursor-pointer flex-col gap-2" htmlFor="username">
                        <div className="flex items-center justify-between">
                          <p className="flex items-center justify-start gap-2 px-0.5 italic tracking-wide">Username*</p>
                        </div>
                        <div className="relative">
                          <input type="text" value="douvy" className="h-10 w-full border-2 bg-dark-gray py-2 px-4 text-sm outline-none focus:border-yellow bg-transparent text-white" name="username" id="username"/>
                        </div>
                      </label>
                    </div>
                  </div>
                  <div className="flex flex-col gap-2">
                    <div className="gap-2 mt-5 text-xs font-semibold uppercase tracking-wide flex w-full flex-col items-stretch justify-center">
                      <label className="flex cursor-pointer flex-col gap-2" htmlFor="email">
                        <div className="flex items-center justify-between">
                          <p className="flex items-center justify-start gap-2 px-0.5 italic tracking-wide">Todoist API key</p>
                        </div>
                        <div className="relative">
