...
export default function SidebarNav({ setConversations, setConversation, setActiveComponent, features, currentRoute, setCurrentRoute, session, userInfo }) {
        ...
        <div>
            <ul className="pl-3">
                ...
                <SidebarItem iconName="fa-solid fa-stars text-yellow" isActive={currentRoute == "/savedResponses" ? true : false} itemText="Saved responses" onClick={() => {
                    router.push('/saved/responses', '/saved/responses', { shallow: true });
